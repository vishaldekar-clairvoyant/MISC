package com.app.misc.wkhtmltopdf.wrapper;

import com.app.misc.wkhtmltopdf.wrapper.configurations.WrapperConfig;
import com.app.misc.wkhtmltopdf.wrapper.page.Page;
import com.app.misc.wkhtmltopdf.wrapper.page.PageType;
import com.app.misc.wkhtmltopdf.wrapper.params.Param;
import com.app.misc.wkhtmltopdf.wrapper.params.Params;
...
public class Pdf {
     ...
     * @throws IOException 
     */
    public void addPageFromString(String htmlString) throws IOException {
    	File temp = File.createTempFile("java-wkhtmltopdf-wrapper" + UUID.randomUUID().toString(), ".html");
        FileUtils.writeStringToFile(temp, htmlString, "UTF-8");
    	Page page = new Page(temp.getAbsolutePath(), PageType.htmlAsString);
    	this.pages.add(page);
    }
